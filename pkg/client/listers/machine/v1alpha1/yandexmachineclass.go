...
type YandexMachineClassLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.YandexMachineClass, err error)
...
// List lists all YandexMachineClasses in the indexer.
func (s *yandexMachineClassLister) List(selector labels.Selector) (ret []*v1alpha1.YandexMachineClass, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.YandexMachineClass))
	})
	return ret, err
}
...
type YandexMachineClassNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.YandexMachineClass, error)
...
// List lists all YandexMachineClasses in the indexer for a given namespace.
func (s yandexMachineClassNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.YandexMachineClass, err error) {
...
// Get retrieves the YandexMachineClass from the indexer for a given namespace and name.
func (s yandexMachineClassNamespaceLister) Get(name string) (*v1alpha1.YandexMachineClass, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("yandexmachineclass"), name)
	}
	return obj.(*v1alpha1.YandexMachineClass), nil
}
