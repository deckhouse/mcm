...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AWSMetadataOptions)(nil), (*machine.AWSMetadataOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AWSMetadataOptions_To_machine_AWSMetadataOptions(a.(*AWSMetadataOptions), b.(*machine.AWSMetadataOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.AWSMetadataOptions)(nil), (*AWSMetadataOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_AWSMetadataOptions_To_v1alpha1_AWSMetadataOptions(a.(*machine.AWSMetadataOptions), b.(*AWSMetadataOptions), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*VsphereMachineClassSpecResourceAllocationInfo)(nil), (*machine.VsphereMachineClassSpecResourceAllocationInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo(a.(*VsphereMachineClassSpecResourceAllocationInfo), b.(*machine.VsphereMachineClassSpecResourceAllocationInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VsphereMachineClassSpecResourceAllocationInfo)(nil), (*VsphereMachineClassSpecResourceAllocationInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo(a.(*machine.VsphereMachineClassSpecResourceAllocationInfo), b.(*VsphereMachineClassSpecResourceAllocationInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*VsphereMachineClassSpecRuntimeOptions)(nil), (*machine.VsphereMachineClassSpecRuntimeOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions(a.(*VsphereMachineClassSpecRuntimeOptions), b.(*machine.VsphereMachineClassSpecRuntimeOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VsphereMachineClassSpecRuntimeOptions)(nil), (*VsphereMachineClassSpecRuntimeOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VsphereMachineClassSpecRuntimeOptions_To_v1alpha1_VsphereMachineClassSpecRuntimeOptions(a.(*machine.VsphereMachineClassSpecRuntimeOptions), b.(*VsphereMachineClassSpecRuntimeOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AWSMachineClassSpec_To_machine_AWSMachineClassSpec(in *AWSMachineClassSpec, out *machine.AWSMachineClassSpec, s conversion.Scope) error {
	...
	out.MetadataOptions = (*machine.AWSMetadataOptions)(unsafe.Pointer(in.MetadataOptions))
...
func autoConvert_machine_AWSMachineClassSpec_To_v1alpha1_AWSMachineClassSpec(in *machine.AWSMachineClassSpec, out *AWSMachineClassSpec, s conversion.Scope) error {
	...
	out.SecretRef = (*v1.SecretReference)(unsafe.Pointer(in.SecretRef))
	out.CredentialsSecretRef = (*v1.SecretReference)(unsafe.Pointer(in.CredentialsSecretRef))
	out.MetadataOptions = (*AWSMetadataOptions)(unsafe.Pointer(in.MetadataOptions))
	out.UseMachineNameAsNodeName = in.UseMachineNameAsNodeName
	return nil
}
...
func autoConvert_v1alpha1_AWSMetadataOptions_To_machine_AWSMetadataOptions(in *AWSMetadataOptions, out *machine.AWSMetadataOptions, s conversion.Scope) error {
...
// Convert_v1alpha1_AWSMetadataOptions_To_machine_AWSMetadataOptions is an autogenerated conversion function.
func Convert_v1alpha1_AWSMetadataOptions_To_machine_AWSMetadataOptions(in *AWSMetadataOptions, out *machine.AWSMetadataOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_AWSMetadataOptions_To_machine_AWSMetadataOptions(in, out, s)
}

func autoConvert_machine_AWSMetadataOptions_To_v1alpha1_AWSMetadataOptions(in *machine.AWSMetadataOptions, out *AWSMetadataOptions, s conversion.Scope) error {
	out.HTTPEndpoint = in.HTTPEndpoint
	out.HTTPTokens = in.HTTPTokens
	out.HTTPPutResponseHopLimit = (*int64)(unsafe.Pointer(in.HTTPPutResponseHopLimit))
	return nil
...
// Convert_machine_AWSMetadataOptions_To_v1alpha1_AWSMetadataOptions is an autogenerated conversion function.
func Convert_machine_AWSMetadataOptions_To_v1alpha1_AWSMetadataOptions(in *machine.AWSMetadataOptions, out *AWSMetadataOptions, s conversion.Scope) error {
	return autoConvert_machine_AWSMetadataOptions_To_v1alpha1_AWSMetadataOptions(in, out, s)
}
...
func autoConvert_v1alpha1_VsphereMachineClassSpec_To_machine_VsphereMachineClassSpec(in *VsphereMachineClassSpec, out *machine.VsphereMachineClassSpec, s conversion.Scope) error {
	...
	out.Region = in.Region
	out.Zone = in.Zone
	out.ClusterNameTag = in.ClusterNameTag
	out.NodeRoleTag = in.NodeRoleTag
	out.Template = in.Template
	out.ResourcePool = in.ResourcePool
	out.VirtualMachineFolder = in.VirtualMachineFolder
	out.MainNetwork = in.MainNetwork
	out.AdditionalNetworks = *(*[]string)(unsafe.Pointer(&in.AdditionalNetworks))
	out.Datastore = in.Datastore
	out.RootDiskSize = in.RootDiskSize
	out.DisableTimesync = in.DisableTimesync
	out.SshKeys = *(*[]string)(unsafe.Pointer(&in.SshKeys))
	out.ExtraConfig = *(*map[string]string)(unsafe.Pointer(&in.ExtraConfig))
	if err := Convert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions(&in.RuntimeOptions, &out.RuntimeOptions, s); err != nil {
		return err
	}
	out.UserData = in.UserData
	out.SecretRef = (*v1.SecretReference)(unsafe.Pointer(in.SecretRef))
...
func autoConvert_machine_VsphereMachineClassSpec_To_v1alpha1_VsphereMachineClassSpec(in *machine.VsphereMachineClassSpec, out *VsphereMachineClassSpec, s conversion.Scope) error {
	...
	out.SshKeys = *(*[]string)(unsafe.Pointer(&in.SshKeys))
	out.ExtraConfig = *(*map[string]string)(unsafe.Pointer(&in.ExtraConfig))
	if err := Convert_machine_VsphereMachineClassSpecRuntimeOptions_To_v1alpha1_VsphereMachineClassSpecRuntimeOptions(&in.RuntimeOptions, &out.RuntimeOptions, s); err != nil {
		return err
	}
	out.UserData = in.UserData
	out.SecretRef = (*v1.SecretReference)(unsafe.Pointer(in.SecretRef))
...
func autoConvert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo(in *VsphereMachineClassSpecResourceAllocationInfo, out *machine.VsphereMachineClassSpecResourceAllocationInfo, s conversion.Scope) error {
	out.CpuShares = (*int32)(unsafe.Pointer(in.CpuShares))
	out.CpuLimit = (*int64)(unsafe.Pointer(in.CpuLimit))
	out.CpuReservation = (*int64)(unsafe.Pointer(in.CpuReservation))
	out.MemoryShares = (*int32)(unsafe.Pointer(in.MemoryShares))
	out.MemoryLimit = (*int64)(unsafe.Pointer(in.MemoryLimit))
	out.MemoryReservation = (*int64)(unsafe.Pointer(in.MemoryReservation))
	return nil
}

// Convert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo is an autogenerated conversion function.
func Convert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo(in *VsphereMachineClassSpecResourceAllocationInfo, out *machine.VsphereMachineClassSpecResourceAllocationInfo, s conversion.Scope) error {
	return autoConvert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo(in, out, s)
}

func autoConvert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo(in *machine.VsphereMachineClassSpecResourceAllocationInfo, out *VsphereMachineClassSpecResourceAllocationInfo, s conversion.Scope) error {
	out.CpuShares = (*int32)(unsafe.Pointer(in.CpuShares))
	out.CpuLimit = (*int64)(unsafe.Pointer(in.CpuLimit))
	out.CpuReservation = (*int64)(unsafe.Pointer(in.CpuReservation))
	out.MemoryShares = (*int32)(unsafe.Pointer(in.MemoryShares))
...
// Convert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo is an autogenerated conversion function.
func Convert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo(in *machine.VsphereMachineClassSpecResourceAllocationInfo, out *VsphereMachineClassSpecResourceAllocationInfo, s conversion.Scope) error {
	return autoConvert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo(in, out, s)
}

func autoConvert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions(in *VsphereMachineClassSpecRuntimeOptions, out *machine.VsphereMachineClassSpecRuntimeOptions, s conversion.Scope) error {
	out.NestedHardwareVirtualization = in.NestedHardwareVirtualization
	if err := Convert_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo_To_machine_VsphereMachineClassSpecResourceAllocationInfo(&in.ResourceAllocationInfo, &out.ResourceAllocationInfo, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions is an autogenerated conversion function.
func Convert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions(in *VsphereMachineClassSpecRuntimeOptions, out *machine.VsphereMachineClassSpecRuntimeOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_VsphereMachineClassSpecRuntimeOptions_To_machine_VsphereMachineClassSpecRuntimeOptions(in, out, s)
}

func autoConvert_machine_VsphereMachineClassSpecRuntimeOptions_To_v1alpha1_VsphereMachineClassSpecRuntimeOptions(in *machine.VsphereMachineClassSpecRuntimeOptions, out *VsphereMachineClassSpecRuntimeOptions, s conversion.Scope) error {
	out.NestedHardwareVirtualization = in.NestedHardwareVirtualization
	if err := Convert_machine_VsphereMachineClassSpecResourceAllocationInfo_To_v1alpha1_VsphereMachineClassSpecResourceAllocationInfo(&in.ResourceAllocationInfo, &out.ResourceAllocationInfo, s); err != nil {
		return err
	}
	return nil
}
